...
- (void)layoutSubviews
{
    ...
    UIImage *image = [UIImage imageWithContentsOfFile:self.imageMessage.imagePath];
...
- (void)bigImageClick:(UIButton * )sender{
    
    [self clickForImageView:self.contentImageView andBigerImage:self.imageView.image];
}
-(void)clickForImageView:(UIImageView *)imageView andBigerImage:(UIImage *)image{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        newImagView.frame = CGRectMake(0, SCREEN_HEIGHT/2.0 - 150, SCREEN_WIDTH, 300);
