...
@interface ContactsViewController ()<ContactsHeaderDelegate,UserGroupDelegate,UISearchBarDelegate>
{
...
{
    NSLog(@"进入群组列表界面...");
    RoomsViewController *roomsViewController = [[RoomsViewController alloc] initWithNibName:nil bundle:nil];
